...
pub fn create_model_matrix(position: (f32, f32), size: (f32, f32), angle_degrees: f32) -> glam::f32::Mat4
{
    glam::f32::Mat4::from_scale_rotation_translation
    (
        Vec3::new(size.0, size.1, 1.0),
        Quat::from_axis_angle(Vec3::new(0.0, 0.0, 1.0), angle_degrees / 180.0 * PI),
